...
# def get_cfgs():
#     env_cfg = {
#         "num_actions": 6,  # Bolt has 6 joints instead of 12
#         # joint/link names
...
#         ],
#         # PD
#         "kp": 200.0,  # Increased from Go2 to match your dummy script
#         "kd": 2.0*math.sqrt(200.0),  # Critical damping as in your dummy script
#         # termination
#         "termination_if_roll_greater_than": 40,  # degree - increased for initial training
#         "termination_if_pitch_greater_than": 40,  # increased for initial training 
#         # base pose
#         "base_init_pos": [0.0, 0.0, 0.5],  # Adjusted height to match your dummy script
...
#     reward_cfg = {
#         "tracking_sigma": 0.25,
#         "base_height_target": 0.5,  # Adjusted for Bolt
#         "reward_scales": {
...
#     command_cfg = {
#         "num_commands": 3,
#         "lin_vel_x_range": [0.5, 0.5],  # Fixed forward command to start
#         "lin_vel_y_range": [0, 0],
#         "ang_vel_range": [0, 0],
#     }
